...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--modo', type=str, choices=['sms', 'whatsapp', 'ambos'], 
                          default='sms', help='Modo de envio: sms, whatsapp ou ambos')
    ...
    def handle(self, *args, **options):
        ...
        # Ler arquivo atual
        try:
            with open('/srv/sisvot/twilio_config.py', 'r') as f:
                conteudo = f.read()
        ...
        if modo == 'sms':
            conteudo = conteudo.replace('USAR_APENAS_SMS = False', 'USAR_APENAS_SMS = True')
            ...
            conteudo = conteudo.replace('USAR_APENAS_SMS = True', 'USAR_APENAS_SMS = False')
        ...
        self.stdout.write("\n💡 Para testar:")
        self.stdout.write("   python manage.py testar_mensagens --telefone=5565999616000 --tipo=whatsapp")
