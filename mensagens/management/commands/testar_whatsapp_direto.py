...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--mensagem', type=str, default='🎉 Teste do sistema de mensagens! WhatsApp funcionando! 🎉', help='Mensagem para enviar')
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"📱 Testando envio de WhatsApp...")
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                self.stdout.write(self.style.SUCCESS("✅ WhatsApp enviado com sucesso!"))
