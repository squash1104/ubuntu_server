...
from . import views
from .views import editar_convidado, excluir_convidado, lista_convidados
...
urlpatterns = [
    ...
    path(
        "cadastrar/<int:colaborador_id>/",
        views.cadastrar_convidado,
        name="cadastrar_convidado_por_colaborador",
    ),
    ...
    path(
        "relatorios/convidados/",
        views.relatorio_convidados_view,
        name="guest_report_form",
    ),
    path("get_bairros_ajax/", views.get_bairros_ajax, name="get_bairros_ajax"),
    path(
        "check_telefone/",
        views.check_telefone_exists,
        name="check_telefone_exists_convidado",
    ),
