    ...
    for convidado in convidado_queryset:
        ...
        for col in selected_columns:
            if col == 'cidade':
                ...
                row_data.append(convidado.colaborador.nome if convidado.colaborador else '')
            elif col == 'data_cadastro':
                row_data.append(convidado.data_cadastro.strftime('%Y-%m-%d %H:%M:%S') if convidado.data_cadastro else '')
            else:
