...
class Cidade(models.Model):
    ...
    latitude_cidade = models.DecimalField(
        max_digits=10, decimal_places=8, null=True, blank=True
    )
    longitude_cidade = models.DecimalField(
...
class Bairro(models.Model):
    ...
    cidade = models.ForeignKey(
        Cidade, on_delete=models.SET_NULL, null=True, blank=True, related_name="bairros"
    )

    latitude_bairro = models.DecimalField(
        max_digits=10, decimal_places=8, null=True, blank=True
    )
    longitude_bairro = models.DecimalField(
        max_digits=11, decimal_places=8, null=True, blank=True
    )
